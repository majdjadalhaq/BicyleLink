...
/* ─── Gradient banner derived from username ────────────────────── */
const getBannerGradient = (name = "") => {
  const palettes = [
    "from-emerald-900 via-teal-800 to-cyan-900",
    "from-slate-900 via-emerald-900 to-teal-800",
    "from-zinc-900 via-slate-800 to-emerald-900",
    "from-neutral-900 via-stone-800 to-emerald-800",
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] dark:bg-[#121212] transition-colors duration-300 pb-20">
      ...
      >
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#FAFAF8] dark:from-[#121212] via-transparent to-transparent z-10" />

        {/* Statistics panel — desktop */}
        <div className="absolute bottom-6 right-6 z-20 hidden md:flex items-center gap-3 animate-reveal">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="relative -mt-14 sm:-mt-16 pb-4">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
            ...
            <div className="flex gap-2 sm:mb-1 flex-wrap">
              {isOwnProfile ? (
                ...
                currentUser && (
                  <Link
                    to={`/listings/${listings?.[0]?._id || ""}?receiverId=${user._id}`}
                    className="flex items-center gap-2 px-4 py-2.5 bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-bold rounded-xl transition-all shadow-lg shadow-emerald-500/20"
                  >
                    <svg
                      width="14"
                      height="14"
          ...
          {/* Mobile stats row */}
          <div className="flex md:hidden items-center justify-around mt-5 py-4 px-4 bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
          ...
          <section id="profile-listings" className="scroll-mt-24">
            <div className="flex items-center justify-between mb-5">
              ...
              <div className="flex items-center gap-1 bg-gray-100 dark:bg-white/5 rounded-xl p-1">
                {[
                  { id: "all", label: `All (${listings?.length || 0})` },
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${listingTab === tab.id ? "bg-white dark:bg-[#1a1a1a] text-emerald-600 dark:text-emerald-400 shadow-sm" : "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"}`}
                  >
                    {tab.label}
                  </button>
                ))}
